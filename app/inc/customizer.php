...
function robledo_presidente_customize_register( $wp_customize ) {
	...
	class RP_Customize_Text_Control extends WP_Customize_Control {
  		public function render_content() {
			?>
	...
	$wp_customize->add_setting('rp_video1_url', array('default' => 'http://www.youtube.com/watch?v=qu5VBQkXY3k',));
	...
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video1_title', array(
		'label' => 'Escriba aquí el título del video destacado:',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video1_title',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video2_title', array(
		'label' => 'Escriba aquí el título del segundo video:',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video2_title',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video3_title', array(
		'label' => 'Escriba aquí el título del tercer video::',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video3_title',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video4_title', array(
		'label' => 'Escriba aquí el título del cuarto video::',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video4_title',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video1_url', array(
		'label' => 'Escriba aquí la URL del video destacado:',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video1_url',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video2_url', array(
		'label' => 'Escriba aquí la URL del segundo video:',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video2_url',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video3_url', array(
		'label' => 'Escriba aquí la URL del tercer video:',
		'section' => 'rp_theme_section',
		'settings' => 'rp_video3_url',
	)));
	$wp_customize->add_control(new WP_Customize_Control($wp_customize, 'rp_video4_url', array(
